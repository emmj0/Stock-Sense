...
import { ChevronDown, ChevronUp, TrendingUp, TrendingDown, MinusCircle } from 'lucide-react';
...
export default function SectorsPage() {
  ...
  if (loading) {
    return (
      <div className="p-6 sm:p-8 max-w-6xl mx-auto flex items-center justify-center">
    ...
    <div className="p-6 sm:p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">PSX Sectors</h1>
            <p className="mt-1 text-gray-600 text-sm">Explore all sectors and their constituent companies</p>
          </div>
        </div>
      ...
      <div>
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-right hidden sm:block">
                      ...
                      <p className="text-lg font-bold text-slate-900">{sector.market_cap} B</p>
                    </div>

                    <div className="text-right hidden sm:block">
                      <p className="text-sm text-gray-500">Turnover</p>
                      <p className="text-lg font-bold text-slate-900">{sector.turnover}</p>
                    </div>
                ...
                {isExpanded && (
                  <div className="border-t border-slate-200 bg-slate-50">
                        ...
                        <table className="w-full">
                          ...
                          <tbody className="divide-y divide-slate-200">
                            {companies.map((company, idx) => (
                              <tr key={company.SYMBOL} className={idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
                    ...
                    <div className="md:hidden px-6 py-4 border-t border-slate-200 bg-white">
                    ...
                    {/* Last Updated */}
                    <div className="px-6 py-3 border-t border-slate-200 bg-gray-100">
        ...
        {sectors.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-medium text-slate-900">No sectors found</h3>
