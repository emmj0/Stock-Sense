...
export default function SignupPage() {
  ...
  const getPasswordStrength = () => {
    if (password.length === 0) return { strength: 0, label: '', color: 'bg-gray-200 dark:bg-dark-border' };
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-dark-bg dark:via-dark-bg dark:to-dark-bg flex items-center justify-center py-12 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-300 text-lg">Start your intelligent investing journey</p>
        </div>
                    ...
                    {[1, 2, 3, 4].map((level) => (
                      <div
                        ...
                        className={`h-1.5 flex-1 rounded-full transition-all duration-300 ${
                          level <= passwordStrength.strength ? passwordStrength.color : 'bg-gray-200 dark:bg-dark-border'
                        }`}
                      />
                    ))}
                  </div>
