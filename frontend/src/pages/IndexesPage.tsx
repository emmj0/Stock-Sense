    ...
    <div className="p-6 sm:p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">PSX Indexes</h1>
            <p className="mt-1 text-gray-600 text-sm">Track all major Pakistan Stock Exchange indexes</p>
          </div>
        </div>
      ...
      <div>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <h3 className="text-xl font-bold text-slate-900">{idx.index}</h3>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-right">
                      <p className="text-2xl font-bold text-slate-900">{idx.current}</p>
                ...
                {isExpanded && (
                  <div className="border-t border-slate-200 bg-slate-50">
                    {/* Mobile High/Low */}
                    <div className="md:hidden px-6 py-4 bg-white border-b border-slate-200">
                        ...
                        <table className="w-full">
                          ...
                          <tbody className="divide-y divide-slate-200">
                            {constituents.map((stock, i) => (
                              <tr key={stock.SYMBOL} className={i % 2 === 0 ? 'bg-white' : 'bg-slate-50'}>
        ...
        {indexes.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-lg font-medium text-slate-900">No indexes found</h3>
