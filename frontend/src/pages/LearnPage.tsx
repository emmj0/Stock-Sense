...
export default function LearnPage() {
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      ...
      default: return 'bg-gray-100 dark:bg-dark-surface text-gray-700 dark:text-gray-300 border-gray-200 dark:border-dark-border';
    }
  };
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
        ...
        <div className="bg-white dark:bg-dark-card border-b border-gray-200 dark:border-dark-border sticky top-0 z-10">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mt-4">{selectedCourse.title}</h1>
            <p className="text-gray-600 dark:text-gray-300 mt-1">{selectedCourse.description}</p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {courseLoading ? (
            ...
            <>
              {/* Reading Tab */}
              {activeTab === 'reading' && (
                <div className="bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border shadow-sm p-8">
              ...
              {activeTab === 'practice' && (
                <div className="bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border shadow-sm p-8">
                  <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Practice Questions</h2>
                  <p className="text-gray-600 dark:text-gray-300 mb-6">Think about these questions to reinforce your learning:</p>
                  
                  <div className="space-y-4">
                    {selectedCourse.content.practiceQuestions.map((question, idx) => (
                      <div key={idx} className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800/30">
                  ...
                  {!quizSubmitted ? (
                    <>
                      ...
                      {selectedCourse.quizzes.map((quiz, idx) => (
                        <div key={quiz.id} className="bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border shadow-sm p-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-white dark:bg-dark-card rounded-2xl border border-gray-200 dark:border-dark-border shadow-sm p-6">
                        <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Your Answers</h3>
                        <div className="space-y-4">
                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm mt-2">
                                    <span className="text-gray-500 dark:text-gray-300">Your answer: </span>
                                  ...
                                  {!result.isCorrect && (
                                    <p className="text-sm">
                                      <span className="text-gray-500 dark:text-gray-300">Correct answer: </span>
                      ...
                      <div className="flex justify-center gap-4">
                        ...
                        <button
                          onClick={closeCourse}
                          className="flex items-center gap-2 px-6 py-3 bg-gray-100 dark:bg-dark-surface text-gray-700 dark:text-gray-300 rounded-full hover:bg-gray-200 dark:hover:bg-dark-hover transition-colors"
                        >
                          Back to Courses
                        </button>
                      </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg">
      ...
      <div className="bg-white dark:bg-dark-card border-b border-gray-200 dark:border-dark-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Learn Stocks</h1>
              <p className="mt-2 text-gray-600 dark:text-gray-300">Master the Pakistan Stock Market step by step</p>
            </div>
            <button
              onClick={loadCourses}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-4">
          {courses.map((course, index) => (
            <div
              key={course.id}
              className={`bg-white dark:bg-dark-card rounded-2xl border-2 shadow-sm overflow-hidden transition-all duration-300 ${
                course.isUnlocked
                  ? 'border-gray-200 dark:border-dark-border hover:border-blue-300 dark:hover:border-blue-500 hover:shadow-lg cursor-pointer'
                  : 'border-gray-100 dark:border-dark-border opacity-75'
              }`}
            ...
            >
              <div className="p-6 flex items-center gap-6">
                ...
                <div className={`flex-shrink-0 w-16 h-16 rounded-2xl flex items-center justify-center ${
                  course.progress.status === 'completed' ? 'bg-green-100 dark:bg-green-900/30' :
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-1">
                    <h3 className={`text-lg font-semibold ${course.isUnlocked ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-500'}`}>
                      {course.title}
                    </h3>
                  ...
                  <p className={`text-sm ${course.isUnlocked ? 'text-gray-600 dark:text-gray-300' : 'text-gray-400 dark:text-gray-500'} line-clamp-2`}>
                    {course.description}
                  </p>
              ...
              {course.isUnlocked && course.progress.status === 'in_progress' && (
                <div className="h-1 bg-gray-100 dark:bg-dark-surface">
                  <div 
